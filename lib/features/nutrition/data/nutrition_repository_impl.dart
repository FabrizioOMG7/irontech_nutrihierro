...
class NutritionRepositoryImpl implements NutritionRepository {
  ...
  final List<Recipe> _mockDatabase = [
    Recipe(
      ...
      imageUrl: 'assets/images/recipes/age_papillas/papilla_sangrecita.png', 
      ironContent: 15,
    ...
    Recipe(
      ...
      imageUrl: 'assets/images/recipes/age_papillas/pure_higado_zanahoria.png',
      ironContent: 12,
      targetAge: AgeCategory.papillas, // 6 a 8 meses
      ingredients: [
    ...
    Recipe(
      ...
      imageUrl: 'assets/images/recipes/age_picados/picadito_bazo_lentejas.png',
      ironContent: 18,
    ...
    Recipe(
      ...
      imageUrl: 'assets/images/recipes/age_olla_familiar/guiso_pescado_oscuro.png',
      ironContent: 10,
    ...
    Recipe(
      ...
      imageUrl: 'assets/images/recipes/age_escolar/arroz_tapado_higado_lentejas.png',
      ironContent: 14,
    ...
    Recipe(
      ...
      imageUrl: 'assets/images/recipes/age_escolar/tortilla_sangrecita_quinua.png',
      ironContent: 16,
      targetAge: AgeCategory.escolar, // 24+ meses
      ingredients: [
